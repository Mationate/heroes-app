...
export const SearchPage = () => {
  ...
  const location = useLocation(); //obtener informacion de ubicacion de donde estamos
  const {q=''} = queryString.parse(location.search) //facilita queries
      ...
      <>
        ...
        <div className="row">
          ...
          <div className="col-7">
            <h4>Results</h4>
            <hr />
            {/* una forma de validar las condicionales de vistas */}
            {/* {
              (q==='')
